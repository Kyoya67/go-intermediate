...
func (s *serviceMock) GetArticleDetailService(articleID int) (models.Article, error) {
...
func (s *serviceMock) GetCommentListService(articleID int) ([]models.Comment, error) {
	return commentTestData, nil
}
